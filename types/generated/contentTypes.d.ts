...
export interface ApiEmployeeEmployee extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    active: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    completed: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    >;
    upcoming: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTrainingTraining extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    traningStatus: Schema.Attribute.Enumeration<
      ['active', 'upcoming', 'completed']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'active'>;
    traningType: Schema.Attribute.Enumeration<['online', 'offline']> &
      Schema.Attribute.Required &
